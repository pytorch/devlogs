...
tags: [distributed, rdma, networking, gpudirect, storage]
---
...
![Measured GPUDirect bandwidth by message size](/devlogs/images/distributed/rdma4py-bandwidth.png)
...
![Measured GPUDirect completion latency by message size](/devlogs/images/distributed/rdma4py-latency.png)
